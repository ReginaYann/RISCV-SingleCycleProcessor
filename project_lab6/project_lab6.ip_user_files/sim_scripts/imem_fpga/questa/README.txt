...
#
# Generated by export_simulation on Tue Dec 29 09:58:42 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './imem_fpga.sh' script.

./imem_fpga.sh -reset_run
...
./imem_fpga.sh -noclean_files

For more information on the script, please type './imem_fpga.sh -help'.
