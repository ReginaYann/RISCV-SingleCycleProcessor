...
HD_PWD='C:/Users/Yan Lijun/Desktop/lab6/project_lab6/project_lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log singleriscv_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source singleriscv_fpga.tcl -notrace
