...
HD_PWD='C:/Users/Yan Lijun/Desktop/lab6/project_lab6/project_lab6.runs/imem_fpga_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imem_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imem_fpga.tcl
