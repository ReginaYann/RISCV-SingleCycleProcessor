...
HD_PWD='C:/Users/Yan Lijun/Desktop/lab6/project_lab6/project_lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singleriscv_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singleriscv_fpga.tcl
